...
class Glass(ArenaFeature):
    ...
    def geometry(self) -> Sequence[object]:
        ...
        # Corner cylinders are used for collision/volume only. Add rendered
        # arc segments so top-down views show rounded glass corners.
        corner_centres = [
            ((+half_len - r, +half_wid - r), 0.0, radians(90.0)),
            ((+half_len - r, -half_wid + r), radians(270.0), radians(360.0)),
            ((-half_len + r, -half_wid + r), radians(180.0), radians(270.0)),
            ((-half_len + r, +half_wid - r), radians(90.0), radians(180.0)),
        ]
