...
from puck_dynamics.geometry import Arc, Circle, Point3D  # type: ignore[attr-defined]
...
class FaceoffCircles(ArenaFeature):
    ...
    def geometry(self) -> Sequence[object]:
        ...
        for cx, cy in centres:
            ...
            geom.append(Arc(circle=circle, start_angle=0.0, end_angle=2 * math.pi, clockwise=False))
