...
_PRIORS: dict[str, ShotPrior] = {
    "wrist": ShotPrior(
        ...
        speed=_cdf_from_hist(
            [16, 20, 24, 28, 32, 36], [8, 28, 38, 20, 6]),  # m/s
        elev=_cdf_from_hist(
            [0, 4, 8, 12, 16, 20], [18, 42, 28, 10, 2]),
        spin=_cdf_from_hist(
    ...
    "slap": ShotPrior(
        ...
        speed=_cdf_from_hist(
            [28, 32, 36, 40, 44], [10, 30, 34, 16]),
        elev=_cdf_from_hist(
            [1, 3, 5, 7, 9], [24, 42, 24, 10]),
        spin=_cdf_from_hist(
    ...
    "snapshot": ShotPrior(
        ...
        speed=_cdf_from_hist(
            [20, 24, 28, 32, 36], [10, 34, 36, 20]),
        elev=_cdf_from_hist(
            [1, 5, 9, 13, 17], [20, 42, 28, 10]),
        spin=_cdf_from_hist(
    ...
    "backhand": ShotPrior(
        ...
        speed=_cdf_from_hist(
            [16, 20, 24, 28, 32], [20, 36, 28, 16]),
        elev=_cdf_from_hist(
            [2, 6, 10, 14, 18], [18, 40, 30, 12]),
        spin=_cdf_from_hist(
    ...
    "tip": ShotPrior(   # includes deflections and tip-ins
        ...
        speed=_cdf_from_hist(
            [ 8, 12, 16, 20, 24], [28, 40, 20, 8]),
        elev=_cdf_from_hist(
            [0, 5, 10, 15, 20], [24, 46, 22, 8]),
        spin=_cdf_from_hist(
